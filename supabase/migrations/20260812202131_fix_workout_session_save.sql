-- Keep the workout RPC aligned with the client and validate the full write in
-- one transaction. This replaces the drifted production definition safely.
...
begin
  ...
  if exists (
    ...
    where s.exercise_id is null
       ...
       or (s.reps is not null and (s.reps < 1 or s.reps > 1000))
